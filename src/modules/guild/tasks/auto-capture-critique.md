...
2. Capture screenshot: `xcrun simctl io booted screenshot /tmp/guild-capture-[timestamp].png`
...
3. Capture screenshot: `await page.screenshot({ path: '/tmp/guild-capture-[timestamp].png', fullPage: true })`
