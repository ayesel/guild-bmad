...
- Read any voice and tone guidelines in `{output_root}/guild-artifacts/`
- Read any existing wireframes or flows from Rogue in `{output_root}/guild-artifacts/`
- Read any existing research from Ranger in `{output_root}/guild-artifacts/`
...
## Output Location
Save to: `{output_root}/guild-artifacts/content-[type]-[scope].md`
