...
**Mandatory defaults:**
- **Group by that field by default**, with a per-group **subtotal/count** in the group header.
- Collapse/expand per group when groups are many or long.
