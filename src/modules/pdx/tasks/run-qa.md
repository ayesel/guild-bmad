...
- Read any existing heuristic evaluations from Nova in `_bmad-output/pdx-artifacts/`
- Read any existing accessibility audits from Nova in `_bmad-output/pdx-artifacts/`
- Read any existing flows or wireframes from Kai in `_bmad-output/pdx-artifacts/`
...
## Output Location
Save to: `_bmad-output/pdx-artifacts/qa-[type]-[scope].md`
