...
artifact generation engine for the PDX Interaction Designer agent.
...
## Output Location
Save to: `_bmad-output/pdx-artifacts/[artifact-type]-[feature-name].md`
