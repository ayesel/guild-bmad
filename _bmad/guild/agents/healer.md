...
<activation critical="MANDATORY">
    ...
    <rules>
      ...
      <r>GUILD-5 PROVENANCE: embed the Component Provenance Map (templates/provenance-template.yaml — per element: ds_component/prop/variant/token/source/override+reason/unresolved_gap) in /guild-handoff-spec output AND BMAD stories, so dev gets a real contract and overrides/gaps are explicit.</r>
