...
At EACH captured breakpoint × state, measure via browser JS eval and write `{output_root}/guild-artifacts/responsive-metrics.json` in the responsive-gate format:
